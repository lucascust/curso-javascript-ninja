...
function convertToHex(cor){
    switch (cor){
        case 'red':
            return "O hexadecimal para a cor " + cor + " é #FF000.";
            
        break
        case 'blue':
            return "O hexadecimal para a cor " + cor + " é #000FF.";
            
        break
        case 'white':
            return "O hexadecimal para a cor " + cor + " é #FFFFF.";
        break
        case 'black':
            return "O hexadecimal para a cor " + cor + " é #00000.";
        break
        case 'gray':
            return "O hexadecimal para a cor " + cor + " é #A0A0A0.";
        break
        default:
