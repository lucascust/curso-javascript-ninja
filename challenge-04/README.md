...
isTruthy([]);
isTruthy(" ");
isTruthy(function(){return 'funcao';});
...
carro.addPessoas = function(num){
    ...
    if (pessoas + num > 5){
        plural = 5 - pessoas === 1? 'pessoa' : plural;
        return "Só cabem mais " + (5 - pessoas) + " " + plural + "!";
    }
    pessoas += num;
    carro.quantidadePessoas = pessoas;
    plural = pessoas === 1? 'pessoa' : plural; 
    return "Já temos " + pessoas + " " + plural + " no Carro!";
